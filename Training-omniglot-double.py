...
if __name__ == '__main__':
    ...
    train_dataset = Dataset(mode="test", val_frac=0.1)
    ...
    # tensor board
    log_dir = TENSOR_BOARD_PATH + datetime.datetime.now().strftime("%Y%m%d-%H%M%S") + "\\double"
    checkpoint_path = TENSOR_BOARD_PATH + datetime.datetime.now().strftime("%Y%m%d-%H%M%S") + "\\double" + "\\model"
